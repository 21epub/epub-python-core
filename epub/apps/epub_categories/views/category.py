...
from epub.apps.epub_categories.serializers.category import CategorySerializer, CategoryRetrieveUpdateDeleteSerializer, \
    CategorySortSerializer, CategoryBatchSerializers
from epub.apps.epub_categories.models.category import Category
from epub.apps.epub_categories.views.filters import CategoryTypeFilterBackend, CategoryUserFilterBackend
...
class CategoryRetrieveUpdateDestroyAPIView(RetrieveUpdateDeleteResponseMixin, generics.RetrieveUpdateDestroyAPIView):
...
class CategoryBatchAPIView(CreateResponseMixin, generics.CreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        ...
        app_model = apps.get_model(serializer.validated_data.get('app_name'), serializer.validated_data.get('model_name'))
