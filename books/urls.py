...
from books.views import BookListCreateAPIView, BookRemarkListCreateAPIView, BookRetrieveUpdateDestroyAPIView
...
urlpatterns = [
    ...
    path("books/<int:pk>", BookRetrieveUpdateDestroyAPIView.as_view(), name="book_single_api"),
    re_path(
        "categories/",
        include(
